    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(DockItem, { createWindow: this.props.createWindow, item: { name: 'terminal' } }),
          _react2.default.createElement(DockItem, { createWindow: this.props.createWindow, item: { name: 'browser' } }),
          _react2.default.createElement(DockItem, { createWindow: this.props.createWindow, item: { name: 'template' } })
        )
      );
    }
  }]);
...
var DockItem = function (_Component2) {
  _inherits(DockItem, _Component2);

  function DockItem(props) {
    _classCallCheck(this, DockItem);

    var _this2 = _possibleConstructorReturn(this, (DockItem.__proto__ || Object.getPrototypeOf(DockItem)).call(this, props));
  ...
  _createClass(DockItem, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'button',
        { className: 'dockItem', onClick: function onClick() {
            return _this3.props.createWindow('/' + _this3.props.item.name + '/');
          } },
        !this.state.imageFailed && _react2.default.createElement('img', { src: 'http://127.0.0.1:1469/' + this.props.item.name + '/bundle/icon.png', onError: function onError() {
            return _this3.setState({ imageFailed: true });
          } })
      );
    }
  }]);
...
*/
var aa=__webpack_require__(2),ba=__webpack_require__(4),m=__webpack_require__(7),p=__webpack_require__(1),v=__webpack_require__(0),da=__webpack_require__(8),ea=__webpack_require__(9),fa=__webpack_require__(10),ha=__webpack_require__(3);
...
// module
exports.push([module.i, ".dockWindow {\n  width: 100vw;\n  position: fixed;\n  bottom: 0px;\n  display: flex;\n  justify-content: center;\n  transform: translateY(64px) translateZ(0px);\n  padding: 12px 0px;\n  transition: transform 0.2s; }\n  .dockWindow:hover {\n    transform: translateY(6px) translateZ(0px); }\n  .dockWindow .dockContainer {\n    transform: translateZ(0px);\n    border-radius: 12px;\n    height: 72px;\n    transition: filter 0.15s; }\n  .dockWindow .dockItem {\n    border: none;\n    cursor: pointer;\n    height: 72px;\n    width: 72px;\n    background: #fff;\n    margin: 0px 4px;\n    border-radius: 12px;\n    padding: 0px;\n    filter: drop-shadow(0px 0px 0px rgba(0, 0, 0, 0));\n    transition: transform 0.1s, filter 0.2s; }\n    .dockWindow .dockItem:focus {\n      outline: none; }\n    .dockWindow .dockItem:hover {\n      transform: scale(1.1);\n      filter: drop-shadow(0px 3px 6px rgba(0, 0, 0, 0.33)); }\n    .dockWindow .dockItem img {\n      width: 64px;\n      height: 64px;\n      margin: 4px; }\n", ""]);
