...
var AppComponent = function (_Component) {
  ...
  _createClass(AppComponent, [{
    ...
    value: function newTab() {
      this.setState({ tabs: [].concat(_toConsumableArray(this.state.tabs), [{ url: 'https://start.duckduckgo.com/', title: 'DuckDuckGo' }]) });
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_tabs2.default, { ref: 'tabs', newTab: this.newTab.bind(this) })
      );
    }
  }]);
...
*/
var aa=__webpack_require__(3),ba=__webpack_require__(1),m=__webpack_require__(7),p=__webpack_require__(2),v=__webpack_require__(0),da=__webpack_require__(8),ea=__webpack_require__(9),fa=__webpack_require__(10),ha=__webpack_require__(4);
...
if(false) {
	module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./window.sass", function() {
		var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./window.sass");
...
// module
exports.push([module.i, ".browserWindow {\n  backdrop-filter: blur(24px);\n  background: rgba(255, 255, 255, 0.66);\n  flex: 1;\n  display: flex;\n  flex-direction: column;\n  width: 100%;\n  height: 100%;\n  font-family: sans-serif;\n  overflow: hidden; }\n  .browserWindow .chrome-tabs-content {\n    display: flex; }\n  .browserWindow .chrome-tab, .browserWindow .newtab {\n    border-right: 1px solid rgba(0, 0, 0, 0.1);\n    overflow: hidden;\n    border-top: 2px solid transpare0; }\n    .browserWindow .chrome-tab:hover .chrome-tab-close, .browserWindow .newtab:hover .chrome-tab-close {\n      background: rgba(0, 0, 0, 0.2); }\n    .browserWindow .chrome-tab .chrome-tab-title, .browserWindow .newtab .chrome-tab-title {\n      padding: 6px;\n      padding-top: 6px;\n      text-overflow: ellipsis;\n      overflow: hidden;\n      padding-right: 18px; }\n    .browserWindow .chrome-tab .chrome-tab-close, .browserWindow .newtab .chrome-tab-close {\n      height: 12px;\n      width: 12px;\n      background: rgba(0, 0, 0, 0.1);\n      position: absolute;\n      top: 8px;\n      right: 6px;\n      border-radius: 100%;\n      cursor: pointer;\n      transition: background 0.1s; }\n      .browserWindow .chrome-tab .chrome-tab-close:hover .chrome-tab-close, .browserWindow .newtab .chrome-tab-close:hover .chrome-tab-close {\n        background: rgba(0, 0, 0, 0.3); }\n  .browserWindow .chrome-tab-current {\n    border-top: 2px solid #0095ff; }\n    .browserWindow .chrome-tab-current .chrome-tab-title {\n      padding-top: 6px; }\n  .browserWindow .chrome-tabs-bottom-bar {\n    border-bottom: 1px solid rgba(0, 0, 0, 0.1); }\n  .browserWindow .chrome-tab-background svg {\n    display: none; }\n  .browserWindow .newtab {\n    max-width: 23px;\n    min-width: 23px;\n    cursor: pointer;\n    transform: translate3d(0px, 0px, 0px) !important; }\n", ""]);
...
var _chromeTabs = __webpack_require__(30);
...
var Tabs = function (_Component) {
  ...
  function Tabs(props) {
    ...
    _this.chromeTabs = new _chromeTabs2.default();
    return _this;
  }
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { ref: 'tabs', className: 'tabs' },
        _react2.default.createElement(
          'div',
          { className: 'chrome-tabs-content' },
          _react2.default.createElement(
            'div',
            { className: 'newtab', onClick: this.props.newTab },
            _react2.default.createElement(
              'div',
        ...
        _react2.default.createElement('div', { className: 'chrome-tabs-bottom-bar' })
      );
    }
  }]);
...
(function(){
  ...
  if (isNodeContext) {
    Draggabilly = __webpack_require__(31)
  }
